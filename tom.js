...
// Hook into the base Highcharts object to stop the download popup from
// showing up. If you comment the code below and click the Export button,
// an SVG download will be triggered. Try it!
...
$(function() {
    ...
    $('#btn').on('click', function() {
        ...
        $('#container').highcharts().exportChartLocal('image/svg+xml');
        $('#container2').highcharts().exportChartLocal('image/svg+xml');
